...
namespace VRTK
{
    ...
    public class VRTK_InteractObjectHighlighter : VRTK_InteractableListener
    {
        ...
        //private void Start()
        //{
        //    _selectorDropzone = GetComponent<SelectorDropzone>();
        //}
...
#pragma warning restore 0618
        ...
        //Событие которое происходит как только пользователь касается контроллером объекта
        protected virtual void TouchHighlightObject(object sender, InteractableObjectEventArgs e)
        {
            //Debug.Log("505");
            //_selectorDropzone._stay = true;
